...
async function hasherMotDePasse(motDePasse: string): Promise<string> {
...
// silencieusement à la prochaine connexion réussie (voir /login).
async function verifierMotDePasse(motDePasse: string, hashStocke: string): Promise<boolean> {
